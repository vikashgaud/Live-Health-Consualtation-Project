...
<%
       ...
       String email=session.getAttribute("em")+"";
        ...
        PreparedStatement ps=con.prepareStatement("select * from patientsignup where email=? and password=?");
        ...
        {
                rs.close();
                PreparedStatement ps1=con.prepareStatement("update patientsignup set password=? where email=?");
