...
<!--                    <input type="file"name="f1">-->
                ...
                <div class="userpic3">
                    <div class="modal-body">
                        <center><h1>Doctor Verification Details</h1></center>
...
<!--                <div class="form-group userpic4">
        ...
        var r=new XMLHttpRequest();
             r.onreadystatechange=function()
             {
                 if(r.readyState===4)
                 {
                         document.getElementById("loaddata2").innerHTML=r.responseText;
                         
                 }
             };
             r.open("post","ajaxapi/loadDVdataApi.jsp");
             r.send();             
         }
         function AdminVerify(x){
             alert(x);
             var license_number=x;
        var r=new XMLHttpRequest();
             r.onreadystatechange=function()
             {
                 if(r.readyState===4)
                 {
                    if(r.responseText.trim()==="Verified"){
                            alert(r.responseText);
                         }
                         
                 }
             };
             r.open("post","ajaxapi/AdminVerifyApi.jsp?license_number="+license_number);
             r.send();             
         }
          </script>      
